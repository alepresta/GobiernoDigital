Feature: Organismos
  ...
  @organismos
  Scenario: Casa Rosada
    Then  01- Casa Rosada

  @organismos
  Scenario: Secretaría General
    Then  02- Secretaría General

  @organismos
  Scenario: Secretaría Legal y Técnica
  ...
  @organismos
  Scenario: Secretaría de Relaciones Políticas y Parlamentarias
    Then  05- Secretaría de Relaciones Políticas y Parlamentarias

  @organismos
  Scenario: Secretaría de Asuntos Estratégicos
    Then  06- Secretaría de Asuntos Estratégicos

  @organismos
  Scenario: Secretaría de Comunicación Pública
    Then  07- Secretaría de Comunicación Pública

  @organismos
  Scenario: Secretaría de Coordinación Interministerial
    Then  08- Secretaría de Coordinación Interministerial

  @organismos
  Scenario: Secretaría de Coordinación de Políticas Públicas
    Then  09- Secretaría de Coordinación de Políticas Públicas

  @organismos
  Scenario: Sistema Federal de Medios y Contenidos Públicos
    Then  10- Sistema Federal de Medios y Contenidos Públicos

  @organismos
  Scenario: Agencia de Administración de Bienes del Estado
    Then  11- Agencia de Administración de Bienes del Estado

  @organismos
  Scenario: Unidad Plan Belgrano
    Then  12- Unidad Plan Belgrano

  @organismos
  Scenario: Dirección Nacional de Inversión Pública
    Then  13- Dirección Nacional de Inversión Pública

  @organismos
  Scenario: Ministerio de Educación, Cultura, Ciencia y Tecnología
    Then  14- Ministerio de Educación, Cultura, Ciencia y Tecnología

  @organismos
  Scenario: Ministerio de Defensa
    Then  15- Ministerio de Defensa

  @organismos
  Scenario: Ministerio de Salud y Desarrollo Social
    Then  16- Ministerio de Salud y Desarrollo Social

  @organismos
  Scenario: Ministerio de Hacienda
    Then  17- Ministerio de Hacienda

  @organismos
  Scenario: Ministerio del Interior, Obras Públicas y Vivienda
    Then  18- Ministerio del Interior, Obras Públicas y Vivienda

  @organismos
  Scenario: Ministerio de Justicia y Derechos Humanos
    Then  19- Ministerio de Justicia y Derechos Humanos

  @organismos
  Scenario: Ministerio de Producción y Trabajo
    Then  20- Ministerio de Producción y Trabajo

  @organismos
  Scenario: Ministerio de Relaciones Exteriores y Culto
    Then  21- Ministerio de Relaciones Exteriores y Culto

  @organismos
  Scenario: Ministerio de Seguridad
    Then  22- Ministerio de Seguridad

  @organismos
  Scenario: Ministerio de Transporte
    Then  23- Ministerio de Transporte

  @organismos
  Scenario: Corte Suprema de Justicia de la Nación
    Then  24- Corte Suprema de Justicia de la Nación

  @organismos
  Scenario: Ministerio Público Fiscal – Procuración General de la Nación
    Then  25- Ministerio Público Fiscal – Procuración General de la Nación

  @organismos
  Scenario: Ministerio Público de la Defensa
    Then  26- Ministerio Público de la Defensa

  @organismos
  Scenario: Congreso de la Nación Argentina
    Then  27- Congreso de la Nación Argentina

  @organismos
  Scenario: Honorable Senado de la Nación
    Then  28- Honorable Senado de la Nación

  @organismos
  Scenario: Honorable Cámara de Diputados de la Nación
